...
let parseMessageName name (element: XElement) =
...
let findMessageElement definitions (name: XName) =
...
let parseSoapBody msgName ns (style: OperationStyle) (abstractParts: Map<string,SchemaName>) (elem: XElement) (opmsg: OperationMessage) =
...
let parseOperationMessage (style: OperationStyle) (binding: XElement) definitions abstractDef ns =
...
let parseOperation operation (portType: XElement) (definitions: XElement) (style: OperationStyle) ns =
...
let parsePortBinding definitions element =
